...
literature on deservingness (van Oorschot, 2000, 2006). Higher values
...
(2007) and Fenger (2007). To classify the countries of southern Europe
and of central and eastern Europe present in the sample, the extensions
of Ferrera (1996), Fenger (2007) and Aidukaite (2011) are followed,
which document both the initial specificity of the post-socialist
regimes and their progressive convergence towards the continental types
after two decades of transition. On that basis, and given the small
number of countries per category, the study adopts a three-regime
classification ---social democratic, liberal and
conservative-corporatist---, in which the countries of southern Europe
and of central and eastern Europe are integrated into the conservative
category, while the Baltic states, characterised by a more liberal
orientation of their post-socialist reforms, are incorporated into the
liberal regime (Aidukaite, 2011).
...
country characteristics (Snijders \& Bosker, 2012; Hox, Moerbeek \& Van
de Schoot, 2017). Random intercepts are estimated for each country to
control heterogeneity at the macro level. The models are estimated
sequentially: a baseline model including only the control variables
(Model 1), a second model adding type of employment and job insecurity
(Model 2), a third model incorporating the perception of technological
risk and benefit (Model 3) and a fourth, full model adding the
perception of the deservingness of others (Model 4). In a fifth model,
interaction terms between the labour market predictors and the type of
welfare regime are introduced to test the moderation hypotheses (Models
5--------). All the analyses use the individual survey weights provided
...
Perceived technological job change
...
All models are controlled by sex, age and income with significant
effects and education with no significant effect
