...
mat1 <- matrixreg(list(reg1, reg2, reg3, reg4, reg5, reg6),
        custom.model.names = paste0("Model ", 1:6),
...
ft1 <- flextable::flextable(df1) %>%
  ...
  flextable::add_footer_lines("Note: Cells contain regression coefficients with standard errors in parentheses. * p < 0.05; ** p < 0.01; *** p < 0.001. Model 6 controls for sex, age, education and income; sex, age and income show significant effects, education does not.") %>%
...
mat2 <- matrixreg(list(reg7, reg8, reg9, reg10, reg11, reg12),
        custom.model.names = paste0("Model ", 7:12),
        stars = c(0.05, 0.01, 0.001),
        omit.coef = omit2,
